...
export default function () {
  ...
  // useNavigate function to navigate the routes
  ...
  return (
    <>
      <SEO
        ...
        description="Budget calculator to create a monthly budget. Use this calculator to see how you are spending your money and where you could save. A budget is a powerful tool to better manage your money."
        name="Build-a-Budget"
        type="calculator"
      />
      <section className="Calculator">
        <section className="slider">
          <button className={`sliderButton1 on`}>Budget</button>
          <button
